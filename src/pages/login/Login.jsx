          ...
          <div className="md:max-w-md w-full sm:px-6 py-4">
            <form>
              ...
              <Inputtitle title={"Password"}></Inputtitle>
                <div className="relative flex items-center">
                  <input  type="password" required className="w-full text-sm border-b border-gray-300 focus:border-[#333] py-3 outline-none" placeholder="Enter password" />
                  <IoEye classNameName="w-[18px] h-[18px] absolute right-2 cursor-pointer"></IoEye>
                </div>
              </div>
